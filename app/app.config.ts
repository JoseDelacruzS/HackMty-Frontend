  ...
  locales: {
    es: defineLocale({
      ...
      messages: {
        ...
        savings: {
          title: "Cajitas de Ahorro",
          subtitle: "Rendimiento diario 14.5% anual",
          totalBalance: "Ahorro total en cajitas",
          totalYield: "Rendimiento acumulado",
          addCajita: "Crear nueva cajita",
          deposit: "Guardar",
          withdraw: "Retirar",
          goal: "Meta: {amount}",
          rate: "14.5% Tasa anual",
          modalDepositTitle: "Guardar en {name}",
          modalWithdrawTitle: "Retirar de {name}",
          modalCreateTitle: "Nueva Cajita de Ahorro",
          amountLabel: "Monto en MXN",
          cajitaNameLabel: "Nombre de la cajita",
          cajitaGoalLabel: "Meta de ahorro (MXN)",
          submit: "Confirmar",
    ...
    en: defineLocale({
      ...
      messages: {
        ...
        savings: {
          ...
          subtitle: "Daily yield 14.5% annual",
          totalBalance: "Total vault balance",
          totalYield: "Accumulated yield",
          addCajita: "Create new vault",
          deposit: "Save",
          withdraw: "Withdraw",
          goal: "Goal: {amount}",
          rate: "14.5% Annual rate",
          modalDepositTitle: "Save to {name}",
          modalWithdrawTitle: "Withdraw from {name}",
          modalCreateTitle: "New Savings Vault",
          amountLabel: "Amount in MXN",
          cajitaNameLabel: "Vault name",
          cajitaGoalLabel: "Savings goal (MXN)",
          submit: "Confirm",
